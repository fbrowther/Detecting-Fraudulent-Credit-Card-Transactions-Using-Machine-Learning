...
In the current use case for detecting fradulent transactions, FN values play a crucial role. 

Detecting lowest possible FN meant lowest possibility of missing out on detecing fraudulent cases.
